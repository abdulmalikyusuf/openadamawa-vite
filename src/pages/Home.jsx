    ...
    <Col className="overflow-hidden">
      <Col className="">
        ...
        <Splide options={{
			...
			<SplideSlide>
				<img src={Image5} fetchpriority="high" data-splide-lazy={Image5} alt="Image 1" className="w-100"/>
			</SplideSlide>
			<SplideSlide>
				<img src={Rectangle} fetchpriority="high" data-splide-lazy={Rectangle} alt="Image 1" className="w-100"/>
			</SplideSlide>
			<SplideSlide>
				<img src={Rectangle} data-splide-lazy={Rectangle} alt="Image 1" className="w-100"/>
			</SplideSlide>
		</Splide>
        </div>
      </Col>
      <Row className="mt-5 px-3 px-md-5">
        <Col xs={12} lg={6}>
          <p className="fs-2 fw-bold">About Open Adamawa Project</p>
